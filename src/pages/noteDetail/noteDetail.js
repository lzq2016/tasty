        ...
        wx.request({
            ...
            success: function (res) {
                ...
                self.setData({
                    ...
                    isCollect: res.data.result.noteMsg.isCollect ? 0 : 1
                })
                res.data.result.noteMsg.isCollect && self.setData({
